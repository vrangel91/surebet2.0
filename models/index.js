...
async function syncModels() {
  try {
    ...
    // Depois, sincronizar especificamente o modelo Notification sem alter: true
    // para evitar erros de SQL com cláusula USING
    try {
      await Notification.sync({ force: false, alter: false });
      console.log('✅ Modelo Notification sincronizado sem alterações');
